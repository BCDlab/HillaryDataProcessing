function [] = ELFI_dataprocessing()
    ...
    % This script was autogenerated (with minor revisions) by EEG_Lab
    ...
    [selectionIndex, leftBlank] = listdlg('PromptString', 'Select an age:',...
                    'SelectionMode', 'single', 'ListString', ageArray);
    age = ageArray{selectionIndex};
    pathToFiles = ['../Data/' age '/'];
    filename = strcat(pathToFiles, 'ELFI_',num2str(subject),'_9.set');
